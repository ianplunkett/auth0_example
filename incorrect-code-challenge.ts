...
/**
 * Generates a random code challenge for the PKCE flow.
...
/**
 * Generates a code verifier from the given code challenge.
 * @param {string} codeChallenge - The code challenge to be hashed.
 * @returns {string} A base64url encoded SHA-256 hash of the code challenge.
 */
function generateCodeVerifier(codeChallenge: string): string {
    return crypto
        .createHash("sha256")
